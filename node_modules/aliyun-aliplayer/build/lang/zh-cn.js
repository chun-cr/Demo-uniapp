module.exports = {
    ...
    "Error_Load_M3U8_Failed_Text" :"【HttpCode-0】获取m3u8文件失败,可能是https证书、跨域问题或DNS解析失败",
    ...
    "Error_Not_Found":"【HttpCode-404】播放地址不存在",
    ...
    "Error_Drm_Params_Missing": "缺少drm.widevine/fairplay等参数",
    "Error_Region_Block_Text": "【HttpCode-403】您所在的地区无法观看该视频",
    ...
    "Error_SW_ScriptURL_Scope": "swScriptURL(子路径:@scope1@)和当前网页(子路径:@scope2@)必须在同一个子路径下",
    ...
    "Error_SW_Https_required": "私有加密播放需要使用 https 环境",
    ...
    "Tip_Drm_Secure_Context": "DRM仅可以在https、localhost、127.0.0.1网页下访问，同时manifest和切片也必须使用https。",
    ...
    "Tip_Drm_Info_Missing": "请检查传入的drm.widevine/fairplay等参数是否有效",
    ...
    "Tip_License_Required": "2024年12月1日起，新版本播放器需要配置License才可以使用，播放器基础功能License免费申请，有效期 1 年，请提前申请以避免无法使用",
    "Tip_License_Params": "申请完成后，请参考此文档将License信息传入SDK",
    "Tip_License_Check": "请确保传入的 license key/domain 参数和点播/直播控制台上获取的完全一致",
    "Tip_License_Domain": "当前网页域名和您的 license 授权域名不一致",
    "Tip_License_Feature": "您的license未授权功能：",
    "Tip_License_Reason": "播放失败，因为您的 License 校验未通过，具体原因：",
    "Live_End":"亲，直播已结束",
    ...
    "Maybe_Cors_Error":"【HttpCode-0】网络请求失败，可能是https证书、跨域问题或DNS解析失败",
    ...
    "License_Empty": "未配置License",
    "License_Not_Found": "License未注册",
    "License_Expired": "License已过期",
    "License_License_Key_Invalid": "LicenseKey无效",
    "License_Domain_Invalid": "域名不匹配",
    "License_Feature_Unauthorized": "功能未授权",
    ...
    "Splayer_Err_Env_Check": "(SP)当前环境不支持播放该视频",
    "Splayer_Err_Coroutine": "(SP)Coroutine 错误",
    "Splayer_Err_Decode": "(SP)解码错误",
    "Splayer_Err_Buffering": "(SP)缓冲区错误",
    "Splayer_Err_Parser_Not_Found": "(SP)不支持的媒体容器"
}
